...
@section('content')
    ...
    <div class="anim-fadeup delay-1" style="display: flex; align-items: center; gap: 14px; margin-bottom: 28px;">
        ...
        <div>
            <div style="font-size: 0.7rem; color: var(--blue-light); text-transform: uppercase; letter-spacing: 1.5px; margin-bottom: 2px;">Komisi Baru</div>
            <h5 style="font-family: 'Playfair Display', serif; color: var(--navy); margin: 0; font-size: 1.4rem;">Tambah Komisi</h5>
        </div>
    </div>

    <form method="POST" action="/admin/commissions" enctype="multipart/form-data">
        @csrf
        <div class="row g-4">
                ...
                <div class="form-card anim-fadeup delay-2">
                    ...
                    <div style="margin-bottom: 22px;">
                        ...
                        <input type="text" name="title" class="form-input-custom"
                               placeholder="Contoh: Character Illustration"
                    ...
                    <div class="row g-3" style="margin-bottom: 22px;">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="category" class="form-input-custom"
                                   placeholder="Ilustrasi, Logo, dll"
                    ...
                    <div>
                        ...
                        <textarea name="description" class="form-input-custom" rows="6"
                                  placeholder="Jelaskan detail komisi ini, termasuk apa saja yang didapat customer...">{{ old('description') }}</textarea>
            ...
            <div class="col-lg-4">
                ...
                <div class="anim-fadeup delay-4" style="display: flex; flex-direction: column; gap: 10px;">
                    <button type="submit" class="btn-navy" style="justify-content: center; padding: 13px;">
                        <i class="bi bi-check2"></i> Simpan Komisi
                    </button>
